...
add_shortcode ('yasr_visitor_votes_only_stars', 'shortcode_visitor_votes_only_stars_callback');

function shortcode_visitor_votes_only_stars_callback ($atts) {
    ...
    if (YASR_ALLOWED_USER === 'allow_anonymous') {
        ...
        if ( is_user_logged_in() ) {
            ...
            if ($vote_if_user_already_rated) {
                ...
                $span_after_rate_it="<span class=\"yasr-small-block-bold\" id=\"yasr-already-voted-text\">" . __("You already voted this article with", "yasr") . " $vote_if_user_already_rated </span>";
